...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <div className="space-y-10 text-sm leading-7" style={{ color: "var(--veulr-text-primary)" }}>

        <section>
          <h2 className="text-base font-semibold mb-3" style={{ color: "var(--veulr-text-primary)" }}>
            1. 事業者
          </h2>
          <p style={{ color: "var(--veulr-text-secondary)" }}>
            tanaka（屋号: Veulr）は、Document Finder（documentfinder.jp）をはじめとするサービス（以下「本サービス」）を提供するにあたり、利用者の個人情報を適切に取り扱います。
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-3 space-y-1 list-disc list-inside" style={{ color: "var(--veulr-text-secondary)" }}>
            <li>氏名またはユーザー名</li>
            <li>メールアドレス</li>
        ...
        <section>
          ...
          <ul className="mt-3 space-y-1 list-disc list-inside" style={{ color: "var(--veulr-text-secondary)" }}>
            <li>Stripe（決済処理）— <a href="https://stripe.com/jp/privacy" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2" style={{ color: "var(--veulr-accent-primary)" }}>stripe.com/jp/privacy</a></li>
            <li>Google（アクセス解析・インフラ）— <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2" style={{ color: "var(--veulr-accent-primary)" }}>policies.google.com/privacy</a></li>
          </ul>
        </section>
        ...
        <section>
          ...
          <address className="mt-3 not-italic space-y-1" style={{ color: "var(--veulr-text-secondary)" }}>
            <p>tanaka（屋号: Veulr）</p>
            <p>愛知県岩倉市大地町葉広64-2</p>
            <p>
              メール:{" "}
